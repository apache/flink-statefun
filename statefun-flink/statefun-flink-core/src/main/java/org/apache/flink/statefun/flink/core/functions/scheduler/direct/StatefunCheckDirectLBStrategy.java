...
public class StatefunCheckDirectLBStrategy extends SchedulingStrategy {

    public int SEARCH_RANGE = 2;
    public boolean USE_DEFAULT_LAXITY_QUEUE = false;

    private transient static final Logger LOG = LoggerFactory.getLogger(StatefunCheckDirectLBStrategy.class);
    ...
    public StatefunCheckDirectLBStrategy(){ }
    ...
    public void initialize(LocalFunctionGroup ownerFunctionGroup, ApplyingContext context){
        ...
        this.messageCount = 0;
        LOG.info("Initialize StatefunCheckDirectStrategy with SEARCH_RANGE " + SEARCH_RANGE + " USE_DEFAULT_LAXITY_QUEUE " + USE_DEFAULT_LAXITY_QUEUE);
    }
