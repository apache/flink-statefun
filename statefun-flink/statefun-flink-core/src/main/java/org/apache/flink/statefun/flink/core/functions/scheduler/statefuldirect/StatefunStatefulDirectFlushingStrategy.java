...
final public class StatefunStatefulDirectFlushingStrategy extends SchedulingStrategy {
    ...
    private transient static final Logger LOG = LoggerFactory.getLogger(StatefunStatefulDirectFlushingStrategy.class);
    ...
    public StatefunStatefulDirectFlushingStrategy(){ }
