...
//                                if(DataflowUtils.getFunctionId(bufferMessage.message.target().type().getInternalType())==2){
//                                    System.out.println("Send message "+ bufferMessage.message + " tid: " + Thread.currentThread().getName());
