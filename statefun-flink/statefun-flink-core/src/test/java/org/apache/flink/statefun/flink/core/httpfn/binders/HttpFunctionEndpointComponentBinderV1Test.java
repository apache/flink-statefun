...
public final class HttpFunctionEndpointComponentBinderV1Test {
  ...
  public void exampleUsage() throws Exception {
    ...
    HttpEndpointComponentBinderV1.INSTANCE.bind(component, universe, new TestExtensionResolver());
  ...
  private static ComponentJsonObject testComponent() throws Exception {
    return new ComponentJsonObject(
        HttpEndpointComponentBinderV1.KIND_TYPE, loadComponentSpec(SPEC_YAML_PATH));
  }

  private static JsonNode loadComponentSpec(String yamlPath) throws Exception {
    final URL url =
        HttpFunctionEndpointComponentBinderV1Test.class.getClassLoader().getResource(yamlPath);
