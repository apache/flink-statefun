...
final class KinesisSerializationSchemaDelegate<T> implements KinesisSerializationSchema<T> {

  private static final long serialVersionUID = 1L;

  private final KinesisEgressSerializer<T> delegate;

  KinesisSerializationSchemaDelegate(KinesisEgressSerializer<T> delegate) {
  ...
  public String getTargetStream(T element) {
    return delegate.targetStream(element);
  }
}
