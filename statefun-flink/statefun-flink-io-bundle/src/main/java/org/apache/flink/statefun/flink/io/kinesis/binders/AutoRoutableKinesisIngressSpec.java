...
@JsonDeserialize(builder = AutoRoutableKinesisIngressSpec.Builder.class)
public class AutoRoutableKinesisIngressSpec {
  ...
  private AutoRoutableKinesisIngressSpec(
  ...
  public KinesisIngressSpec<Message> toUniversalKinesisIngressSpec() {
    ...
    KinesisIngressBuilderApiExtension.withDeserializer(
        builder, new AutoRoutableKinesisIngressDeserializer(streamRoutings));
  ...
  public static class Builder {
    ...
    public AutoRoutableKinesisIngressSpec build() {
      return new AutoRoutableKinesisIngressSpec(
  ...
  private static List<TargetFunctionType> parseTargetFunctions(JsonNode routingJsonNode) {
    ...
    return StreamSupport.stream(targetFunctionNodes.spliterator(), false)
        .map(AutoRoutableKinesisIngressSpec::parseTargetFunctionType)
