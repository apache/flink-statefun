...
public final class AutoRoutableKinesisIngressDeserializer
  ...
  public AutoRoutableKinesisIngressDeserializer(Map<String, RoutingConfig> routingConfigs) {
  ...
  private String requireNonNullKey(String partitionKey) {
    if (partitionKey == null) {
      TypeName tpe = AutoRoutableKinesisIngressComponentBinderV1.KIND_TYPE;
      throw new IllegalStateException(
          "The "
              + tpe.namespace()
              + "/"
