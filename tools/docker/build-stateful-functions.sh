...
mkdir -p ${docker_context_flink}/usrlib
mkdir -p ${docker_context_flink}/usrlib/distribution
mkdir -p ${docker_context_flink}/usrlib/core
cp ${distribution_jar} ${docker_context_flink}/usrlib/distribution/statefun-flink-distribution.jar
cp ${core_jar} ${docker_context_flink}/usrlib/core/statefun-flink-core.jar
